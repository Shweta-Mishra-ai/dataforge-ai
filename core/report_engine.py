...
class ReportTheme:
    ...
    # Accent & text
    accent:         tuple = (26,  74, 138)
    accent_light:   tuple = (235, 242, 255)
...
class ReportData:
    ...
    def __post_init__(self):
        self.generated_at = datetime.now().strftime(
            "%B %d, %Y — %H:%M"
        )
```
...
Commit karo:
```
Fix report_engine.py - add THEMES dict and ReportTheme
